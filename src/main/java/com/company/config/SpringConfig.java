...
public class SpringConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers("/product/public", "/product/public/*", "/product/public/**").permitAll()
                ...
                .antMatchers("/product/adm", "/product/adm/*", "/product/adm/**").hasAnyRole("ADMIN")
                .antMatchers("/sale/adm", "/sale/adm/*").hasAnyRole("ADMIN")
                .antMatchers("/basket/adm", "/basket/adm/*").hasAnyRole("ADMIN")
                .antMatchers("/sale/adm/**").hasAnyRole("ADMIN")
                .antMatchers("/product/emp", "/product/emp/*", "/product/emp/**").hasAnyRole("EMPLOYEE", "ADMIN")
                .antMatchers("/sale/emp", "/sale/emp/*", "/sale/emp/**").hasAnyRole("EMPLOYEE", "ADMIN")
                .antMatchers("/basket/emp", "/basket/emp/*", "/basket/emp/**").hasAnyRole("EMPLOYEE", "ADMIN")
